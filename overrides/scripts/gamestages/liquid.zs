...
GameStagesUtil.stageAwakened.addLiquid(<liquid:fire_alloy>);
GameStagesUtil.stageAwakened.addLiquid(<liquid:sky_alloy>);
GameStagesUtil.stageAwakened.addLiquid(<liquid:ice_alloy>);
