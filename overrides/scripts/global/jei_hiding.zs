...
JEI.addDescription(<thaumicwonders:primordial_grain>,"§c第一份元始晶粒使用元始加速器获得");
...
JEI.addDescription([<additions:taigaddon-heaven_gem_shard1>,<additions:taigaddon-heaven_gem_shard2>],"击败§c蔚蓝浩空§fBOSS获得");
