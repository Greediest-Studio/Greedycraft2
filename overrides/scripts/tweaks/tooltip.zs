...
val tooltipMap as string[][IIngredient] = {
    ...
    <modularmachinery:mek_changer_factory_controller> : [game.localize("greedycraft.tooltip.modularmachinery.not_need_blueprints")],
    <modularmachinery:bright_altar_controller> : [game.localize("greedycraft.tooltip.modularmachinery.not_need_blueprints")],
    <modularmachinery:bright_altar_factory_controller> : [game.localize("greedycraft.tooltip.modularmachinery.not_need_blueprints")],
    <modularmachinery:vethea_enchanter_controller> : [game.localize("greedycraft.tooltip.modularmachinery.not_need_blueprints")],
    <modularmachinery:vethea_enchanter_factory_controller> : [game.localize("greedycraft.tooltip.modularmachinery.not_need_blueprints")],
    <modularmachinery:factory_atomic_vibrator_controller> : [game.localize("greedycraft.tooltip.modularmachinery.not_need_blueprints")],
    <modularmachinery:factory_atomic_vibrator_factory_controller> : [game.localize("greedycraft.tooltip.modularmachinery.not_need_blueprints")],
    <modularmachinery:factory_atomic_decayer_controller> : [game.localize("greedycraft.tooltip.modularmachinery.not_need_blueprints")],
