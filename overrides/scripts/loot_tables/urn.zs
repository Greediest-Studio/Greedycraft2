...
addItem(<additions:reward_ticket_common>, 18, 1, 1, 2);
addItem(<additions:reward_ticket_rare>, 5, 1, 1, 1);
addItem(<additions:reward_ticket_epic>, 1, 1, 1, 1);
addItem(<additions:medkit_super>, 1, 1, 1, 1);
addItem(<additions:medkit_big>, 4, 1, 1, 3);
addItem(<additions:medkit_small>, 20, 1, 1, 6);
addItem(<additions:experience_ingot>, 18, 1, 2, 12);
addItem(<scalinghealth:crystalshard>, 1, 1, 1, 2);
addItem(<scalinghealth:heartdust>, 4, 1, 4, 24);
addItem(<additions:delivery_order>, 8, 1, 1, 1);
addItem(<additions:tower_chest_key>, 10, 1, 1, 1);
addItem(<additions:tcsponsors-sponsor_chest_fragment>, 5, 1, 1, 3);
addItem(<additions:sponsor2-chest_fragment>, 5, 1, 1, 3);
addItem(<additions:huaji>, 8, 1, 1, 2);
...
addItem(<additions:food_bag>, 2, 1, 1, 1);
addItem(<additions:furniture_crate>, 2, 1, 1, 1);
addItem(<sakura:sakura_diamond>, 2, 1, 3, 8);
addItem(<additions:purifying_dust>, 3, 1, 10, 40);
