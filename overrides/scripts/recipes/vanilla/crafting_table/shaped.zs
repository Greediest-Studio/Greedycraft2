...
recipes.addShaped(<modularmachinery:blockaspectprovideroutput> * 1, [[<modularmachinery:itemmodularium>, <thaumcraft:tube>, <modularmachinery:itemmodularium>], [<thaumcraft:tube>, <modularmachinery:blockcasing:0>, <thaumcraft:tube>],[<thaumcraft:ingot:0>, <thaumcraft:ingot:0>, <thaumcraft:ingot:0>]]);
...
recipes.addShaped(<modularmachinery:blockaspectproviderinput>, [[<modularmachinery:itemmodularium>, <thaumcraft:tube>, <modularmachinery:itemmodularium>],[<thaumcraft:tube>, <modularmachinery:blockcasing>, <thaumcraft:tube>], [<thaumcraft:ingot:2>, <thaumcraft:ingot:2>, <thaumcraft:ingot:2>]]);
