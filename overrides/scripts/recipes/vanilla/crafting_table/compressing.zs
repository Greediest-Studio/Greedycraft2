...
val compressingRecipes as IItemStack[IItemStack] = {
    ...
    <additions:botaniaddon-holium_ingot> : <additions:botaniaddon-holium_block>,
    <additions:botaniaddon-holium_nugget> : <additions:botaniaddon-holium_ingot>,
    <additions:greedycraft-enderite_ingot> : <additions:greedycraft-enderite_block>,
    <additions:greedycraft-aetherite_ingot> : <additions:greedycraft-aetherite_block>,
    <additions:greedycraft-glowing_crystal> : <additions:greedycraft-glowing_crystal_block>,
