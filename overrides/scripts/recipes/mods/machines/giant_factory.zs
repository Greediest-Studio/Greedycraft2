...
RecipeBuilder.newBuilder("ae2" , "giant_factory" , "1")
...
RecipeBuilder.newBuilder("ae3" , "giant_factory" , "1")
...
RecipeBuilder.newBuilder("ae4" , "giant_factory" , "1")
...
RecipeBuilder.newBuilder("ae5" , "giant_factory" , "1")
...
RecipeBuilder.newBuilder("ae6" , "giant_factory" , "1")
...
RecipeBuilder.newBuilder("eve_ium" , "giant_factory" , "1")
    ...
    .build();
RecipeBuilder.newBuilder("eve_ium1" , "giant_factory" , "1")
    ...
    .build();
RecipeBuilder.newBuilder("eve_ium2" , "giant_factory" , "1")
    ...
    .build();
RecipeBuilder.newBuilder("eve_ium3" , "giant_factory" , "1")
    ...
    .build();
RecipeBuilder.newBuilder("eve_ium4" , "giant_factory" , "1")
...
RecipeBuilder.newBuilder("awakened_core" , "giant_factory" , "40")
    .addItemInput(<minecraft:nether_star> * 1)
    ...
    .build();
RecipeBuilder.newBuilder("relifed_core" , "giant_factory" , "40")
    .addItemInput(<minecraft:nether_star> * 1)
    .addItemInput(<ore:coreExcellent> * 2)
...
RecipeBuilder.newBuilder("chaotic_core" , "giant_factory" , "100")
    ...
    .build();
RecipeBuilder.newBuilder("stormy_core" , "giant_factory" , "100")
...
//块
RecipeBuilder.newBuilder("draconic_block" , "giant_factory" , "10")
    ...
    .build();
RecipeBuilder.newBuilder("wither_block" , "giant_factory" , "10")
...
RecipeBuilder.newBuilder("chaotic_draconium_block" , "giant_factory" , "40")
    ...
    .build();
RecipeBuilder.newBuilder("stormy_witherium_block" , "giant_factory" , "40")
...
RecipeBuilder.newBuilder("ruled_draconium_block" , "giant_factory" , "100")
    ...
    .build();
RecipeBuilder.newBuilder("equipment_witherium_block" , "giant_factory" , "100")
...
//金属
RecipeBuilder.newBuilder("wyvern_ingot" , "giant_factory" , "20")
    ...
    .build();
RecipeBuilder.newBuilder("fallen_metal_ingot" , "giant_factory" , "20")
    .addItemInput(<tconevo:material> * 1)
    .addItemInput(<minecraft:diamond> * 2)
    .addItemInput(<ore:blockRedstone> * 1)
...
RecipeBuilder.newBuilder("draconic_ingot" , "giant_factory" , "40")
    .addItemInput(<tconevo:material> * 1)
    ...
    .build();
RecipeBuilder.newBuilder("relifed_metal_ingot" , "giant_factory" , "40")
    .addItemInput(<tconevo:material> * 1)
    .addItemInput(<minecraft:nether_star> * 2)
    .addItemInput(<draconicevolution:wyvern_energy_core> * 1)
...
RecipeBuilder.newBuilder("chaoticmetal" , "giant_factory" , "100")
    .addItemInput(<tconevo:material> * 1)
    ...
    .build();
RecipeBuilder.newBuilder("stormy_metal_ingot" , "giant_factory" , "100")
    .addItemInput(<tconevo:material> * 1)
    .addItemInput(<minecraft:dragon_egg> * 2)
    .addItemInput(<draconicevolution:draconic_energy_core> * 1)
    .addItemInput(<gct_ores:stormy_core> * 1)
...
//太阳能
RecipeBuilder.newBuilder("solar_panel_wyvern" , "giant_factory" , "100")
    ...
    .build();
RecipeBuilder.newBuilder("solar_panel_draconic" , "giant_factory" , "100")
    ...
    .build();
RecipeBuilder.newBuilder("solar_panel_chaotic" , "giant_factory" , "100")
    .addItemInput(<draconicevolution:chaotic_core> * 1)
...
//注入装置
RecipeBuilder.newBuilder("crafting_injector_wyv" , "giant_factory" , "100")
    ...
    .build();
RecipeBuilder.newBuilder("crafting_injector_dra" , "giant_factory" , "100")
    ...
    .build();
RecipeBuilder.newBuilder("crafting_injector_chaos" , "giant_factory" , "100")
...
//合成组件
RecipeBuilder.newBuilder("craft1" , "giant_factory" , "10")
    ...
    .build();
RecipeBuilder.newBuilder("craft2" , "giant_factory" , "10")
    .addItemInput(<extendedcrafting:material:2> * 1)
    ...
    .build();
RecipeBuilder.newBuilder("craft3" , "giant_factory" , "10")
    .addItemInput(<extendedcrafting:material:2> * 1)
    ...
    .build();
RecipeBuilder.newBuilder("craft4" , "giant_factory" , "10")
    .addItemInput(<extendedcrafting:material:2> * 1)
    ...
    .build();
RecipeBuilder.newBuilder("craft5" , "giant_factory" , "10")
    .addItemInput(<extendedcrafting:material:2> * 1)
    ...
    .build();
RecipeBuilder.newBuilder("craft_ava" , "giant_factory" , "10")
...
//秩序相关
RecipeBuilder.newBuilder("stormy_crystal_gem" , "giant_factory" , "10")
    .addItemInput(<gct_ores:stormy_shard_block> * 1)
    ...
    .build();
RecipeBuilder.newBuilder("chaotic_crystal_gem" , "giant_factory" , "10")
    .addItemInput(<gct_ores:chaos_shard_block> * 1)
    .addItemInput(<gct_ores:shalloite> * 2)
    .addItemInput(<biomesoplenty:terrestrial_artifact> * 2)
    .addEnergyPerTickInput(100000)
    ...
    .build();
RecipeBuilder.newBuilder("ordered_fusion_core" , "giant_factory" , "100")
...
RecipeBuilder.newBuilder("electronium_ingot" , "giant_factory" , "10")
    .addItemInput(<tconevo:material> * 1)
    ...
    .build();
RecipeBuilder.newBuilder("creative_shard" , "giant_factory" , "100")
    .addItemInput(<draconicevolution:chaotic_core> * 1)
    ...
    .build();
RecipeBuilder.newBuilder("mythsteel_plate" , "giant_factory" , "100")
    ...
    .build();
RecipeBuilder.newBuilder("barrier" , "giant_factory" , "100")
    ...
    .build();
RecipeBuilder.newBuilder("energy_crystal" , "giant_factory" , "10")
    ...
    .build();
RecipeBuilder.newBuilder("chaos_crystal_stable" , "giant_factory" , "100")
    ...
    .build();
RecipeBuilder.newBuilder("reactor_core" , "giant_factory" , "100")
    .addItemInput(<draconicevolution:chaos_shard> * 1)
    ...
    .build();
RecipeBuilder.newBuilder("chaos_stabilizer_core" , "giant_factory" , "100")
    ...
    .build();
RecipeBuilder.newBuilder("reactor_component" , "giant_factory" , "100")
    ...
    .build();
RecipeBuilder.newBuilder("reactor_component1" , "giant_factory" , "100")
    .addItemInput(<draconicevolution:wyvern_core> * 1)
    ...
    .build();
RecipeBuilder.newBuilder("draconium_chest" , "giant_factory" , "100")
    ...
    .build();
RecipeBuilder.newBuilder("dislocator_advanced" , "giant_factory" , "100")
    ...
    .build();
RecipeBuilder.newBuilder("command_core" , "giant_factory" , "100")
    ...
    .build();
RecipeBuilder.newBuilder("command_block" , "giant_factory" , "100")
    ...
    .build();
RecipeBuilder.newBuilder("rng_relinquisher" , "giant_factory" , "100")
    .addItemInput(<draconicevolution:chaotic_core> * 1)
    ...
    .build();
RecipeBuilder.newBuilder("creepy_wither_doll" , "giant_factory" , "100")
    ...
    .build();
RecipeBuilder.newBuilder("creepy_witherstorm_doll" , "giant_factory" , "100")
