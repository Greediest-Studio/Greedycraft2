...
MachineModifier.addCoreThread("advanced_miner", FactoryRecipeThread.createCoreThread("主世界过滤网").addRecipe("upgrade_overworld"));
MachineModifier.addCoreThread("advanced_miner", FactoryRecipeThread.createCoreThread("下界过滤网").addRecipe("upgrade_nether"));
MachineModifier.addCoreThread("advanced_miner", FactoryRecipeThread.createCoreThread("末地过滤网").addRecipe("upgrade_end"));
...
var advOverworld = RecipeBuilder.newBuilder("upgrade_overworld", "advanced_miner", 200);
...
var advNether = RecipeBuilder.newBuilder("upgrade_nether", "advanced_miner", 200);
...
var advEnd = RecipeBuilder.newBuilder("upgrade_end", "advanced_miner", 200);
