...
static nolist as string[] = [
    ...
    "modularmachinery:mana_powereducer"
];
...
val nolistitem as IItemStack[] = [
    ...
    <modularmachinery:mana_powereducer_controller>
];
...
for i in 2 to 7 {
    RecipeBuilder.newBuilder("controller_miner_mana" + i, "builder_" + i, 1200)
        ...
        .addItemInput(<additions:manalapis_ore> * 32)
...
for i in 4 to 7 {
    RecipeBuilder.newBuilder("controller_mana_powereducer" + i, "builder_" + i, 1666)
        ...
        .addItemOutput(<modularmachinery:mana_powereducer_factory_controller>)
...
for i in 3 to 7 {
    RecipeBuilder.newBuilder("controller_blood_altar_mk7" + i, "builder_" + i, 1666)
        ...
        .addItemInput(<additions:slate_6> * 4)
        .addEnergyPerTickInput(2400)
...
for i in 4 to 7 {
    RecipeBuilder.newBuilder("controller_aura_crafter" + i, "builder_" + i, 1200)
        ...
        .addItemInput(<additions:token_emotion> * 4)
...
for i in 3 to 7 {
    RecipeBuilder.newBuilder("ore_5x" + i, "builder_" + i, 800)
        .addFluidInput(<liquid:redstone> * 128000)
        .addItemInput(<additions:modularium_block> * 16)
...
for i in 3 to 7 {
    RecipeBuilder.newBuilder("big_grinder" + i, "builder_" + i, 800)
        .addFluidInput(<liquid:redstone> * 128000)
        .addItemInput(<additions:modularium_block> * 8)
...
for i in 4 to 7 {
    RecipeBuilder.newBuilder("big_miner" + i, "builder_" + i, 10000)
        ...
        .addItemInput(<additions:arcane_control_circuit> * 128)
