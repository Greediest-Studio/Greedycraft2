...
RecipeBuilder.newBuilder(regName + "_leaves", regName, speed, 0)
    ...
    .setChance(0.125f)
    .addItemOutput(<additions:plant_fibre>)
    .setChance(0.15f)
...
RecipeBuilder.newBuilder(regName + "_stone", regName, speed, 0)
    ...
    .addItemOutput(<thermalfoundation:material:2053>)
    .setChance(0.006f)
    .addItemOutput(<additions:chromium_ore>)
    .setChance(0.0025f)
    .addItemOutput(<mekanism:oreblock>)
    .setChance(0.003f)
    .addItemOutput(<divinerpg:rupee_ore>)
    .setChance(0.001f)
    .addItemOutput(<divinerpg:realmite_ore>)
    .setChance(0.001f)
    .addItemOutput(<divinerpg:arlemite_ore>)
    .setChance(0.0005f)
    .build();
...
RecipeBuilder.newBuilder(regName + "_cobble", regName, speed, 0)
    ...
    RecipeBuilder.newBuilder(regName + "_cobble1", regName, speed, 0)
    .addItemInput(<extendedae:infinity_cell>.withTag({r: {Craft: 0 as byte, Cnt: 1 as long, id: "minecraft:cobblestone", Count: 1, Damage: 0 as short, Req: 0 as long}, t: "i"}))
    .setChance(0)
    .setParallelizeUnaffected(true)
    .addItemInput(<appliedenergistics2:io_port>)
    .setChance(0)
    .setParallelizeUnaffected(true)
    .addEnergyPerTickInput(energy)
    .addFluidInput(<liquid:water> * 50)
...
RecipeBuilder.newBuilder(regName + "_dirt", regName, speed, 0)
    ...
    .setChance(0.003f)
    .addItemOutput(<additions:delivery_order>)
    .setChance(0.000375f)
    .build();
...
RecipeBuilder.newBuilder(regName + "_grass", regName, speed, 0)
    ...
    .addItemOutput(<minecraft:carrot>)
    .setChance(0.003f)
    .addItemOutput(<additions:lucky_clover>)
    .setChance(0.001f)
    .addItemOutput(<additions:delivery_order>)
    .setChance(0.000625f)
    .build();
