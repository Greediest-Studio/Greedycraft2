...
RecipeBuilder.newBuilder("ae6" , "factory_giant" , "1")
    .addItemInput(<additions:germanium_ingot> * 4)
    .addItemInput(<ore:itemSilicon> * 4)
    .addItemInput(<minecraft:redstone> * 4)
    .addEnergyPerTickInput(1000)
    .addItemOutput(<additions:wireless_processor> * 8)
    .build();
...
RecipeBuilder.newBuilder("ae9" , "factory_giant" , "1")
    ...
    .addItemInput(<minecraft:redstone> * 4)
    .addEnergyPerTickInput(1000)
    .addItemOutput(<additions:calculation_processor_2> * 8)
    .build();
...
RecipeBuilder.newBuilder("ae10" , "factory_giant" , "1")
    ...
    .addItemInput(<minecraft:redstone> * 4)
    .addEnergyPerTickInput(1000)
    .addItemOutput(<additions:engineering_processor_2> * 8)
    .build();
...
RecipeBuilder.newBuilder("ae11" , "factory_giant" , "1")
    ...
    .addItemInput(<minecraft:redstone> * 4)
    .addEnergyPerTickInput(1000)
    .addItemOutput(<additions:logic_processor_2> * 8)
    .build();
...
RecipeBuilder.newBuilder("balancite_ingot" , "factory_giant" , "1")
    ...
    .addEnergyPerTickInput(1000)
    .addItemOutput(<additions:balancite_ingot> * 4)
    .build();
...
RecipeBuilder.newBuilder("eve_ium2" , "factory_giant" , "1")
    .addItemInput(<additions:aetherium_ingot> * 1)
    .addItemInput(<additions:mistium_ingot> * 1)
    .addItemInput(<additions:canopium_ingot> * 1)
    .addItemInput(<additions:thyminite_ingot> * 1)
    .addEnergyPerTickInput(1000)
    .addItemOutput(<gct_ores:sky_alloy_ingot> * 4)
    .build();
RecipeBuilder.newBuilder("eve_ium3" , "factory_giant" , "1")
    .addItemInput(<additions:lavarite_ingot> * 1)
    .addItemInput(<additions:plasmarite_ingot> * 1)
    .addItemInput(<additions:bnightium_ingot> * 1)
    .addItemInput(<additions:guaninite_ingot> * 1)
    .addEnergyPerTickInput(1000)
    .addItemOutput(<gct_ores:fire_alloy_ingot> * 4)
    .build();
RecipeBuilder.newBuilder("eve_ium4" , "factory_giant" , "1")
    .addItemInput(<additions:snowingium_ingot> * 1)
    .addItemInput(<additions:freezite_ingot> * 1)
    .addItemInput(<additions:oceanium_ingot> * 1)
    .addItemInput(<additions:adeninite_ingot> * 1)
    .addEnergyPerTickInput(1000)
...
RecipeBuilder.newBuilder("astronicium_ingot" , "factory_giant" , "1")
    ...
    .addEnergyPerTickInput(1000)
    .addItemOutput(<additions:astronicium_ingot> * 2)
    .build();
...
RecipeBuilder.newBuilder("raisium_ingot" , "factory_giant" , "1")
    ...
    .addEnergyPerTickInput(1000)
    .addItemOutput(<additions:raisium_ingot> * 3)
    .build();
...
RecipeBuilder.newBuilder("compressite_ingot" , "factory_giant" , "1")
    .addItemInput(<additions:astronicium_ingot> * 2)
    .addItemInput(<additions:raisium_ingot> * 2)
    .addItemInput(<tiths:ingot_stellarium> * 1)
    .addEnergyPerTickInput(1000)
    .addItemOutput(<additions:compressite_ingot> * 2)
    .build();
...
RecipeBuilder.newBuilder("ingot_scientificite" , "factory_giant" , "1")
    ...
    .addItemInput(<additions:porpezite_ingot> * 9)
    .addItemInput(<gct_ores:balanced_matrix_ingot> * 1)
    .addEnergyPerTickInput(1000)
    .addItemOutput(<additions:scientificite_ingot> * 3)
    .build();
...
RecipeBuilder.newBuilder("eugardite_ingot" , "factory_giant" , "1")
    ...
    .addItemInput(<additions:dullium_ingot> * 2)
    .addEnergyPerTickInput(1000)
    .addItemOutput(<additions:eugardite_ingot> * 4)
    .build();
...
RecipeBuilder.newBuilder("eucite_ingot" , "factory_giant" , "1")
    ...
    .addEnergyPerTickInput(1000)
    .addItemOutput(<additions:eucite_ingot> * 4)
    .build();

RecipeBuilder.newBuilder("decurrium_ingot" , "factory_giant" , "1")
    .addItemInput(<additions:eucite_ingot> * 3)
    .addItemInput(<additions:corbite_ingot> * 2)
...
RecipeBuilder.newBuilder("corbite_ingot" , "factory_giant" , "1")
    ...
    .addEnergyPerTickInput(1000)
    .addItemOutput(<additions:corbite_ingot> * 2)
    .build();
...
RecipeBuilder.newBuilder("husturite_ingot" , "factory_giant" , "1")
    ...
    .addEnergyPerTickInput(1000)
    .addItemOutput(<additions:husturite_ingot> * 1)
    .build();
...
RecipeBuilder.newBuilder("twilight_crystal_ingot" , "factory_giant" , "1")
    ...
    .addEnergyPerTickInput(1000)
    .addItemOutput(<additions:twilight_crystal_ingot> * 1)
    .build();

RecipeBuilder.newBuilder("thermallite_ingot" , "factory_giant" , "100")
    .addItemInput(<additions:balance_core> * 1)
    ...
    .addEnergyPerTickInput(10000)
    .addItemOutput(<additions:thermallite_ingot> * 1)
    .build();
//龙研
//核心
...
RecipeBuilder.newBuilder("chaotic_draconium_block" , "factory_giant" , "40")
    ...
    .addItemInput(<contenttweaker:chaos_heart> * 2)
...
RecipeBuilder.newBuilder("craft4" , "factory_giant" , "10")
    .addItemInput(<extendedcrafting:material:2> * 1)
    .addItemInput(<additions:radiation_matrix> * 2)
    .addItemInput(<extendedcrafting:material:7> * 2)
    .addEnergyPerTickInput(1000000)
...
RecipeBuilder.newBuilder("craft_ava" , "factory_giant" , "10")
    ...
    .addItemInput(<ore:coreExcellent> * 2)
    .addItemInput(<additions:ancient_tome_fragment> * 2)
    .addEnergyPerTickInput(10000000)
...
RecipeBuilder.newBuilder("stormy_crystal_gem" , "factory_giant" , "10")
    ...
    .addEnergyPerTickInput(100000)
    .addItemOutput(<additions:stormy_crystal_gem> * 1)
    .build();
RecipeBuilder.newBuilder("chaotic_crystal_gem" , "factory_giant" , "10")
    ...
    .addItemInput(<biomesoplenty:terrestrial_artifact> * 2)
    .addEnergyPerTickInput(100000)
    .addItemOutput(<additions:chaotic_crystal_gem> * 1)
    .build();
...
RecipeBuilder.newBuilder("creative_shard" , "factory_giant" , "100")
    ...
    .addItemInput(<additions:ancient_tome_page> * 2)
    .addItemInput(<additions:bounty_hunter_medal> * 1)
    .addItemInput(<additions:sand_of_time> * 1)
    .addEnergyPerTickInput(10000000)
    .addItemOutput(<additions:creative_shard> * 1)
    .build();
RecipeBuilder.newBuilder("mythsteel_plate" , "factory_giant" , "100")
    .addItemInput(<botanicadds:gaia_plate> * 1)
    .addItemInput(<additions:mythsteel_ingot> * 4)
    .addItemInput(<additions:cosmilite_ingot> * 4)
    .addItemInput(<additions:reversed_orichalcos> * 4)
...
RecipeBuilder.newBuilder("reactor_core" , "factory_giant" , "100")
    ...
    .addItemInput(<tconevo:metal:5> * 2)
    .addItemInput(<contenttweaker:chaotic_energy_core> * 2)
...
RecipeBuilder.newBuilder("command_core" , "factory_giant" , "100")
    ...
    .addItemInput(<additions:harcadium_ingot> * 4)
    .addItemInput(<additions:void_essence> * 4)
    .addItemInput(<additions:adamantium_ingot> * 4)
...
RecipeBuilder.newBuilder("rng_relinquisher" , "factory_giant" , "100")
    .addItemInput(<draconicevolution:chaotic_core> * 1)
    .addItemInput(<additions:harcadium_ingot> * 2)
    .addItemInput(<additions:void_essence> * 2)
...
RecipeBuilder.newBuilder("creepy_wither_doll" , "factory_giant" , "100")
    .addItemInput(<additions:harcadium_block> * 1)
