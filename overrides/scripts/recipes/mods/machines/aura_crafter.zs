...
RecipeBuilder.newBuilder("aurune_craft_four", "aura_crafter", 100)
    ...
    .addItemInput(<minecraft:dye:15>)
    .addAuraInput(200, true)
    .addItemOutput(<additions:token_emotion>)
    .build();
...
RecipeBuilder.newBuilder("aurune_craft_twelve", "aura_crafter", 100)
    ...
    .addItemInput(<naturesaura:sky_ingot> * 2)
    .addItemInput(<additions:twilight_crystal_ingot> * 2)
    .addItemInput(<additions:daynight_ingot> * 2)
    .addAuraInput(200, true)
    .addItemOutput(<additions:fabric_of_nature>)
    .build();
...
RecipeBuilder.newBuilder("aurune_craft_thirteen", "aura_crafter", 100)
    ...
    .addItemInput(<additions:token_emotion> * 2)
    .addItemInput(<additions:terra_alloy_block>)
    .addItemInput(<additions:fusion_matrix_block>)
    .addAuraInput(200, true)
