...
SummoningDirector.addSummonInfo(
    SummoningInfo.create()
        ...
        .addMob(MobInfo.create()
            .setMob("blue_skies:summoner_illager")
            .setCount(1)
            .setOffset(0,4,0)
            .setSpread(1,1,1)
        ...
        .setMutator(function (attempt as SummoningAttempt) {
            ...
            if (!pass1) {
                ...
                attempt.message = LangUtil.translate("greedycraft.zensummoning.summoner.fail.1");
            } else if (!pass2) {
                attempt.success = false;
                ...
                attempt.message = LangUtil.translate("greedycraft.zensummoning.summoner.success");
            }
        })
);
