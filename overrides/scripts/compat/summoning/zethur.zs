...
SummoningDirector.addSummonInfo(
    SummoningInfo.create()
        ...
        .addMob(MobInfo.create()
            ...
            .setOffset(0,4,0)
            .setSpread(1,4,1)
            .setData({"Health": ZETHUR_HP, "Attributes":[{"Name":"generic.maxHealth","Base": ZETHUR_HP}]})
        )
        .addMob(MobInfo.create()
            .setMob("aether_legacy:zephyr")
        ...
        .setMutator(function (attempt as SummoningAttempt) {
            ...
            if (!pass1) {
                ...
                attempt.message = LangUtil.translate("greedycraft.zensummoning.zethur.fail.1");
            } else if (!pass2) {
                attempt.success = false;
                attempt.message = LangUtil.translate("greedycraft.zensummoning.zethur.fail.2");
                ...
                attempt.message = LangUtil.translate("greedycraft.zensummoning.zethur.success");
            }
        })
);
