...
val removedRecipes as IIngredient[] = [
    ...
    <thebetweenlands:bl_bucket_plant_tonic:1>.withTag({usages: 0}),
    ...
    <flux_applied:flux_storage_component_1k>,
    <flux_applied:flux_storage_component_4k>,
    <flux_applied:flux_storage_component_16k>,
    <flux_applied:flux_storage_component_64k>,
    <flux_applied:flux_storage_component_256k>,
    <flux_applied:flux_storage_component_1m>,
    <flux_applied:flux_storage_component_4m>,
    <flux_applied:flux_storage_component_16m>,
    <flux_applied:flux_storage_component_64m>,
    <flux_applied:flux_storage_component_256m>,
    <flux_applied:flux_storage_component_1g>,
...
val removedRecipeNames as string[] = [
    ...
    "thermalfoundation:ardite_ingot",
    "thermalfoundation:ardite_ingot_1",
    "thermalfoundation:ardite_ingot_2",
    "thermalfoundation:chloroplast_ingot",
    "thermalfoundation:chloroplast_ingot_1",
    "thermalfoundation:chloroplast_ingot_2",
    "thermalfoundation:sanite_ingot",
    "thermalfoundation:sanite_ingot_1",
    "thermalfoundation:sanite_ingot_2",
    "thermalfoundation:imitatium_ingot",
    "thermalfoundation:imitatium_ingot_1",
    "thermalfoundation:imitatium_ingot_2",
    "thermalfoundation:tanatonium_ingot",
    "thermalfoundation:tanatonium_ingot_1",
    "thermalfoundation:tanatonium_ingot_2",
    "thermalfoundation:ethaxium_ingot",
    "thermalfoundation:ethaxium_ingot_1",
    "thermalfoundation:ethaxium_ingot_2",
    "thermalfoundation:dreadium_ingot",
