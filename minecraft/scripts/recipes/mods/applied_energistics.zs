...
Inscriber.addRecipe(<additions:cadmium_chalcogenide_plate>, <additions:cadmium_chalcogenide_ingot>, true, <additions:cd_chalcogenite_press>);
...
Inscriber.addRecipe(<additions:calculation_circuit_printed_4>, <additions:arimite_ingot>, true, <additions:calculation_press_4>);
Inscriber.addRecipe(<additions:engineering_circuit_printed_4>, <additions:gemundyingember>, true, <additions:engineering_press_4>);
Inscriber.addRecipe(<additions:logic_circuit_printed_4>, <moretcon:ingotirradium>, true, <additions:logic_press_4>);
Inscriber.addRecipe(<additions:calculation_processor_4>, <minecraft:redstone>, false, <additions:calculation_circuit_printed_4>, <additions:cadmium_chalcogenide_plate>);
Inscriber.addRecipe(<additions:engineering_processor_4>, <minecraft:redstone>, false, <additions:engineering_circuit_printed_4>, <additions:cadmium_chalcogenide_plate>);
Inscriber.addRecipe(<additions:logic_processor_4>, <minecraft:redstone>, false, <additions:logic_circuit_printed_4>, <additions:cadmium_chalcogenide_plate>);
