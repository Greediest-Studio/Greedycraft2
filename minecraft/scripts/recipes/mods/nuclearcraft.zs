...
var UN as IItemStack = <additions:uranyl_nitrate>;
var NpN as IItemStack = <additions:neptunyl_nitrate>;
var PuN as IItemStack = <additions:plutonyl_nitrate>;
var AmN as IItemStack = <additions:americium_nitrate>;
var CmN as IItemStack = <additions:curium_nitrate>;
var BkN as IItemStack = <additions:berkelium_nitrate>;
var CfN as IItemStack = <additions:californium_nitrate>;
var Es252N as IItemStack = <additions:einsteinium_252_nitrate>;
var UIngot as IItemStack = <mekanism:ingot:8>;
var NpIngot as IItemStack = <additions:neptunium_ingot>;
var PuIngot as IItemStack = <additions:plutonium_ingot>;
var AmIngot as IItemStack = <additions:americium_ingot>;
var CmIngot as IItemStack = <additions:curium_ingot>;
var BkIngot as IItemStack = <additions:berkelium_ingot>;
var CfIngot as IItemStack = <additions:californium_ingot>;
...
Melter.addRecipe(UN, <liquid:uranyl_nitrate> * 666);
Melter.addRecipe(NpN, <liquid:neptunyl_nitrate> * 666);
Melter.addRecipe(PuN, <liquid:plutonyl_nitrate> * 666);
Melter.addRecipe(AmN, <liquid:americium_nitrate> * 666);
Melter.addRecipe(CmN, <liquid:curium_nitrate> * 666);
Melter.addRecipe(BkN, <liquid:berkelium_nitrate> * 666);
Melter.addRecipe(CfN, <liquid:californium_nitrate> * 666);
Melter.addRecipe(Es252N, <liquid:einsteinium_252_nitrate> * 666, 8.0d, 40.0d, 0.004d);
...
IngotFormer.addRecipe(<liquid:liquidpenguinite> * 144, <moretcon:ingotpenguinite>);
...
ChemicalReactor.addRecipe(<liquid:phosphorus> * 144, <liquid:liquidchlorine> * 1500, <liquid:phosphorus_trichloride> * 1000, null);
...
ChemicalReactor.addRecipe(<liquid:plutonyl_nitrate> * 666, <liquid:hydrogen> * 1500, <liquid:plutonium> * 144, <liquid:nitrogen_dioxide> * 250, 2.0d, 4.0d, 0.0d);
ChemicalReactor.addRecipe(<liquid:americium_nitrate> * 666, <liquid:hydrogen> * 1500, <liquid:americium> * 144, <liquid:nitrogen_dioxide> * 250, 2.0d, 4.0d, 0.0d);
ChemicalReactor.addRecipe(<liquid:curium_nitrate> * 666, <liquid:hydrogen> * 1500, <liquid:curium> * 144, <liquid:nitrogen_dioxide> * 250, 2.0d, 4.0d, 0.0d);
ChemicalReactor.addRecipe(<liquid:berkelium_nitrate> * 666, <liquid:hydrogen> * 1500, <liquid:berkelium> * 144, <liquid:nitrogen_dioxide> * 250, 2.0d, 4.0d, 0.0d);
ChemicalReactor.addRecipe(<liquid:californium_nitrate> * 666, <liquid:hydrogen> * 1500, <liquid:californium> * 144, <liquid:nitrogen_dioxide> * 250, 2.0d, 4.0d, 0.0d);
ChemicalReactor.addRecipe(<liquid:einsteinium_252_nitrate> * 666, <liquid:hydrogen> * 1500, <liquid:einsteinium_252> * 144, <liquid:nitrogen_dioxide> * 250, 8.0d, 40.0d, 0.004d);
...
ChemicalReactor.addRecipe(<liquid:carbon_monoxide> * 250, <liquid:ammonia> * 250, <liquid:formamide> * 250, null);
...
ChemicalReactor.addRecipe(<liquid:ethene> * 250, <liquid:hydrogen_peroxide> * 250, <liquid:ethylene_glycol> * 250, null);
ChemicalReactor.addRecipe(<liquid:acetone> * 250, <liquid:hydrogen_cyanide> * 250, <liquid:2_hydroxy_2_methylpropanenitrile> * 250, null);
...
ChemicalReactor.addRecipe(<liquid:ethene> * 250, <liquid:liquidchlorine> * 250, <liquid:1_2_dichloroethane> * 250, null);
ChemicalReactor.addRecipe(<liquid:2_chloroethylamine> * 500, <liquid:ammonia> * 1000, <liquid:ethylenediamine> * 500, <liquid:ammonium_chloride_solution> * 333);
ChemicalReactor.addRecipe(<liquid:1_2_dichloroethane> * 500, <liquid:ammonia> * 1000, <liquid:2_chloroethylamine> * 500, <liquid:ammonium_chloride_solution> * 333);
ChemicalReactor.addRecipe(<liquid:ethylenediamine> * 250, <liquid:2_chloroethylamine> * 250, <liquid:diethylenetriamine> * 250, <liquid:liquidhydrogenchloride> * 250);
ChemicalReactor.addRecipe(<liquid:acetic_acid> * 250, <liquid:liquidchlorine> * 250, <liquid:chloroacetic_acid> * 250, <liquid:liquidhydrogenchloride> * 250);
ChemicalReactor.addRecipe(<liquid:diethylenetriaminepentaacetic_acid_pentasodium_salt_solution> * 500, <liquid:hydrochloric_acid> * 2500, <liquid:diethylenetriaminepentaacetic_acid_solution> * 333, <liquid:sodium_chloride> * 1665, 2.0d, 6.0d, 0.0d);
...
ChemicalReactor.addRecipe(<liquid:liquidhydrogenchloride> * 250, <liquid:sulfur_trioxide> * 250, <liquid:chlorosulfonic_acid> * 250, null);
ChemicalReactor.addRecipe(<liquid:benzene> * 250, <liquid:ethene> * 250, <liquid:ethylbenzene> * 250, null);
ChemicalReactor.addRecipe(<liquid:ethylbenzene> * 250, <liquid:ethene> * 250, <liquid:p_diethylbenzene> * 250, null);
...
Crystallizer.addRecipe(<liquid:americium_nitrate_solution> * 666, AmN, 2.0d, 4.0d, 0.0d);
Crystallizer.addRecipe(<liquid:curium_nitrate_solution> * 666, CmN, 2.0d, 4.0d, 0.0d);
Crystallizer.addRecipe(<liquid:berkelium_nitrate_solution> * 666, BkN, 2.0d, 4.0d, 0.0d);
Crystallizer.addRecipe(<liquid:californium_nitrate_solution> * 666, CfN, 2.0d, 4.0d, 0.0d);
Crystallizer.addRecipe(<liquid:einsteinium_252_nitrate_solution> * 666, Es252N, 8.0d, 40.0d, 0.004d);

IngotFormer.addRecipe(<liquid:uranium> * 144, UIngot, 1.0d, 1.0d, 0.0d);
IngotFormer.addRecipe(<liquid:neptunium> * 144, NpIngot, 1.0d, 1.0d, 0.0d);
IngotFormer.addRecipe(<liquid:plutonium> * 144, PuIngot, 1.0d, 1.0d, 0.0d);
IngotFormer.addRecipe(<liquid:americium> * 144, AmIngot, 1.0d, 1.0d, 0.0d);
IngotFormer.addRecipe(<liquid:curium> * 144, CmIngot, 1.0d, 1.0d, 0.0d);
IngotFormer.addRecipe(<liquid:berkelium> * 144, BkIngot, 1.0d, 1.0d, 0.0d);
IngotFormer.addRecipe(<liquid:californium> * 144, CfIngot, 1.0d, 1.0d, 0.0d);
IngotFormer.addRecipe(<liquid:einsteinium_252> * 144, <contenttweaker:einsteinium52>, 8.0d, 40.0d, 0.004d);
...
Enricher.addRecipe(UN, <liquid:water> * 1000, <liquid:uranyl_nitrate_solution> * 666, 2.0d, 4.0d, 0.0d);
Enricher.addRecipe(NpN, <liquid:water> * 1000, <liquid:neptunyl_nitrate_solution> * 666, 2.0d, 4.0d, 0.0d);
Enricher.addRecipe(PuN, <liquid:water> * 1000, <liquid:plutonyl_nitrate_solution> * 666, 2.0d, 4.0d, 0.0d);
Enricher.addRecipe(AmN, <liquid:water> * 1000, <liquid:americium_nitrate_solution> * 666, 2.0d, 4.0d, 0.0d);
Enricher.addRecipe(CmN, <liquid:water> * 1000, <liquid:curium_nitrate_solution> * 666, 2.0d, 4.0d, 0.0d);
Enricher.addRecipe(BkN, <liquid:water> * 1000, <liquid:berkelium_nitrate_solution> * 666, 2.0d, 4.0d, 0.0d);
Enricher.addRecipe(CfN, <liquid:water> * 1000, <liquid:californium_nitrate_solution> * 666, 2.0d, 4.0d, 0.0d);
Enricher.addRecipe(Es252N, <liquid:water> * 1000, <liquid:einsteinium_252_nitrate_solution> * 666, 8.0d, 40.0d, 0.004d);
...
Radiation.setMaterialRadiationLevel("AmericiumNitrate", number(1.22d, m));
