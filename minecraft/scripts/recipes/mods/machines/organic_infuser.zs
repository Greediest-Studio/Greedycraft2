...
val crops as IItemStack[][] = [
    ...
    [<mysticalagriculture:tier7_inferium_seeds>, <mysticalagriculture:crafting> * 7],
    [<mysticalagriculture:tier8_inferium_seeds>, <mysticalagriculture:crafting> * 8],
    [<mysticalagriculture:tier9_inferium_seeds>, <mysticalagriculture:crafting> * 9],
...
for row in crops {
    ...
    var tier = 0;
    if (essence.definition.id != "mysticalagriculture:crafting") {
