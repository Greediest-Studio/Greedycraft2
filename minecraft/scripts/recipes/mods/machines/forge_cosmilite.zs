...
MMEvents.onControllerGUIRender("cosmic_forge", function(event as ControllerGUIRenderEvent) {
    var info as string[] = [
        "§a///寰宇熔合机控制面板///",
        "§a机器名称：§eLV4 - 寰宇熔合机"
    ];
...
MachineModifier.setMaxParallelism("cosmic_forge", 65536);
MachineModifier.setInternalParallelism("cosmic_forge", 1);
MachineModifier.setMaxThreads("cosmic_forge", 1);
...
RecipeBuilder.newBuilder("cosmilite_forge", "cosmic_forge", 7200, 1)
    ...
    .addCatalystInput(
        <additions:blackhole_alloy_ingot>, ["§e加工时间减少到80%", "§e能量消耗减少到80%", "§e材料产出增加到105%"], [
            RecipeModifierBuilder.create(TIME, "input", 0.8f, 1, false).build(),
    ...
    .addCatalystInput(
        <additions:flux_ingot>, ["§e加工时间减少到30%", "§e能量消耗减少到75%", "§e材料产出增加到102%"], [
    ...
    .addCatalystInput(
        <additions:pe_ingot>, ["§e加工时间减少到80%", "§e材料产出增加到103%"], [
            RecipeModifierBuilder.create(TIME, "input", 0.8f, 1, false).build(),
    ...
    .addCatalystInput(
        <additions:enderite_ingot>, ["§e加工时间减少到90%", "§e能量消耗减少到80%", "§e材料产出增加到106%"], [
    ...
    .addCatalystInput(
        <additions:anti_entropy_matter>, ["§e加工时间减少到90%", "§e能量消耗减少到90%", "§e材料产出增加到108%"], [
            RecipeModifierBuilder.create(TIME, "input", 0.9f, 1, false).build(),
    ...
    .addCatalystInput(
        <additions:aurora_heart>, ["§e加工时间减少到40%", "§e能量消耗减少到40%", "§e材料产出增加到108%"], [
            RecipeModifierBuilder.create(TIME, "input", 0.4f, 1, false).build(),
    ...
    .addCatalystInput(
        <additions:sand_of_time>, ["§e加工时间减少到75%"], [
            RecipeModifierBuilder.create(TIME, "input", 0.75f, 1, false).build(),
        ]
    ).setChance(1.0f)
    .addCatalystInput(
    ...
    .addCatalystInput(
        <additions:catalyst_star>, ["§e加工时间减少到75%", "§e能量消耗减少到75%"], [
            RecipeModifierBuilder.create(TIME, "input", 0.75f, 1, false).build(),
            RecipeModifierBuilder.create(RF, "input", 0.75f, 1, false).build(),
        ]
    ).setChance(1.0f)
