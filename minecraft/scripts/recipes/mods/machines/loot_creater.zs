...
RecipeBuilder.newBuilder("kianaex" , "loot_creater" , 900, 2)
    ...
    .addItemOutput(<extrabotany:treasurebox> * 1)
    .addItemOutput(<extrabotany:specialbag> * 3)
    .addItemOutput(<additions:kianate_ingot> * 1)
    .addItemOutput(<additions:kianate_ingot> * 1).setChance(0.5)
    .build();
...
RecipeBuilder.newBuilder("blackstone" , "loot_creater" , 500, 2)
    ...
    .addEnergyPerTickInput(250000)
    .addItemOutput(<additions:dullium_ingot> * 32)
    .build();
...
RecipeBuilder.newBuilder("betwnite" , "loot_creater" , 250,2)
    ...
    .addEnergyPerTickInput(50000)
    .addItemOutput(<additions:rotiron_scrap> * 16)
    .addItemOutput(<additions:dirtshape> * 8)
    .addItemOutput(<additions:bone_shard> * 8)
...
RecipeBuilder.newBuilder("twilit" , "loot_creater" , 250, 2)
    ...
    .addItemOutput(<additions:eden_ingot> * 8)
    .addItemOutput(<additions:wildwood_ingot> * 8)
    .addItemOutput(<additions:apalachia_ingot> * 8)
    .addItemOutput(<additions:skythern_ingot> * 8)
    .addItemOutput(<additions:mortum_ingot> * 8)
    .build();

RecipeBuilder.newBuilder("evilcraft" , "loot_creater" , 250, 2)
    .addFluidInput(<liquid:lifeessence> * 100000)
    .addItemInput(<additions:gloomy_passport> * 1).setChance(0.3)
    .addEnergyPerTickInput(50000)
    .addItemOutput(<additions:darkest_core>.withTag({display: {Name: "§0至暗之核"}}) * 8)
    .build();
