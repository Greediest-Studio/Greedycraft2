...
SagMill.addRecipe([<additions:time_fragment>, <additions:time_fragment>, <additions:experience_ingot>], [20 as float, 20 as float, 50 as float], <ore:dungeonLootTier1> as IIngredient, "CHANCE_ONLY", 12000, [10 as float, 10 as float, 10 as float]);
SagMill.addRecipe([<additions:time_fragment> * 2, <additions:time_fragment>, <additions:time_fragment>, <additions:experience_ingot> * 3], [10 as float, 30 as float, 30 as float, 50 as float], <ore:dungeonLootTier2> as IIngredient, "CHANCE_ONLY", 30000, [25 as float, 25 as float, 25 as float, 25 as float]);
SagMill.addRecipe([<additions:time_fragment> * 6, <additions:time_fragment> * 4, <additions:time_fragment> * 3, <additions:experience_ingot> * 16], [30 as float, 40 as float, 50 as float, 60 as float], <ore:dungeonLootTier3> as IIngredient, "CHANCE_ONLY", 100000, [100 as float, 100 as float, 100 as float, 100 as float]);

SagMill.addRecipe([<additions:purifying_dust> * 8], [100 as float], <botania:specialflower>.withTag({type: "puredaisy"}) as IIngredient, "CHANCE_ONLY", 600, [100 as float]);
...
AlloySmelter.addRecipe(<additions:enderite_ingot>, [<ore:gemResonantDebris> * 4, <ore:ingotIridium> * 4], 6000, 50.0f);
...
AlloySmelter.addRecipe(<tiths:ingot_royal_alloy> * 3, [<ore:ingotIron> * 2, <ore:ingotGold>, <ore:foodCheese> * 10], 4000, 10.0f);
