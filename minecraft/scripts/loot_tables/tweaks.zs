...
dungeonPool2.addItemEntry(<additions:reward_ticket_common>, 4, 1, [Functions.setCount(1, 2)], []);
dungeonPool2.addItemEntry(<additions:reward_ticket_rare>, 1, 1, [Functions.setCount(1, 1)], []);
dungeonPool2.addItemEntry(<additions:medkit_super>, 1, 1, [Functions.setCount(1, 1)], []);
dungeonPool2.addItemEntry(<additions:medkit_big>, 3, 1, [Functions.setCount(1, 3)], []);
dungeonPool2.addItemEntry(<additions:medkit_small>, 10, 1, [Functions.setCount(1, 6)], []);
dungeonPool2.addItemEntry(<additions:experience_ingot>, 12, 1, [Functions.setCount(4, 20)], []);
...
dungeonPool2.addItemEntry(<additions:delivery_order>, 1, 1, [Functions.setCount(1, 1)], []);
dungeonPool2.addItemEntry(<additions:tower_chest_key>, 2, 1, [Functions.setCount(1, 1)], []);
dungeonPool2.addItemEntry(<additions:sunny_doll>, 2, 1, [Functions.setCount(1, 1)], []);
dungeonPool2.addItemEntry(<additions:bag_of_dyes>, 6, 1, [Functions.setCount(1, 3)], []);
dungeonPool2.addItemEntry(<additions:tcsponsors-sponsor_chest_fragment>, 2, 1, [Functions.setCount(1, 3)], []);
dungeonPool2.addItemEntry(<additions:sponsor2-chest_fragment>, 2, 1, [Functions.setCount(1, 3)], []);
dungeonPool2.addItemEntry(<additions:huaji>, 1, 1, [Functions.setCount(1, 1)], []);
