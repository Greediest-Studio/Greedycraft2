...
LootUtil.addItem(<additions:blood_sigil>, 2, 1, 1, 1);
...
LootUtil.addItem(<additions:one_punch>.withTag({ench: [{lvl: 33 as short, id: 19}]}), 1, 1, 1, 1);
LootUtil.addItem(<additions:reward_ticket_common>, 25, 1, 1, 3);
LootUtil.addItem(<additions:reward_ticket_rare>, 8, 1, 1, 2);
LootUtil.addItem(<additions:reward_ticket_epic>, 2, 1, 1, 1);
LootUtil.addItem(<additions:medkit_super>, 1, 1, 1, 1);
LootUtil.addItem(<additions:medkit_big>, 4, 1, 1, 3);
LootUtil.addItem(<additions:medkit_small>, 16, 1, 1, 6);
LootUtil.addItem(<additions:experience_ingot>, 18, 1, 2, 12);
LootUtil.addItem(<scalinghealth:crystalshard>, 3, 1, 1, 1);
LootUtil.addItem(<scalinghealth:heartdust>, 10, 1, 3, 12);
LootUtil.addItem(<additions:delivery_order>, 3, 1, 1, 1);
LootUtil.addItem(<additions:tower_chest_key>, 2, 1, 1, 1);
LootUtil.addItem(<additions:sunny_doll>, 4, 1, 1, 1);
LootUtil.addItem(<additions:bag_of_dyes>, 6, 1, 1, 3);
...
LootUtil.addItem(<additions:sponsor2-chest>, 1, 1, 1, 1);
LootUtil.addItem(<additions:sponsor2-chest_fragment>, 6, 1, 1, 2);
LootUtil.addItem(<additions:true_eye_of_ender>, 1, 1, 1, 1);
...
LootUtil.addItem(<additions:huaji>, 3, 1, 1, 1);
LootUtil.addItem(<additions:poop>, 8, 1, 1, 2);
LootUtil.addItem(<additions:experience_transporter>, 1, 1, 1, 1);
LootUtil.addItem(<additions:blueprint_laser_gun>, 1, 1, 1, 1);
LootUtil.addItem(<additions:blueprint_ring>, 1, 1, 1, 1);
LootUtil.addItem(<actuallyadditions:block_treasure_chest>, 9, 1, 1, 1);
LootUtil.addItem(<additions:skill_reset_scroll>, 1, 1, 1, 1);
LootUtil.addItem(<additions:plate_of_honor>, 1, 1, 1, 1);
LootUtil.addItem(<additions:purifying_dust>, 3, 1, 10, 40);
LootUtil.addItem(<additions:perfectly_generic_item>, 2, 1, 1, 1);
LootUtil.addItem(<additions:respawn_anchor>, 1, 1, 1, 1);
LootUtil.addItem(<additions:loli_lolipop>, 3, 1, 1, 2);
LootUtil.addItem(<additions:food_bag>, 4, 1, 1, 1);
LootUtil.addItem(<additions:furniture_crate>, 3, 1, 1, 1);
...
LootUtil.addItem(<additions:strange_matter>, 1, 1, 1, 1);
...
LootUtil.addHardmodeItem(<additions:catalyst_star>, 3, 1, 1, 2);
...
LootUtil.addHardmodeItem(<additions:time_shard>, 1, 1, 1, 2);
LootUtil.addHardmodeItem(<additions:time_fragment>, 4, 1, 2, 5);
...
LootUtil.addHardmodeItem(<additions:compressed_experience_block>, 2, 1, 2, 5);
LootUtil.addHardmodeItem(<additions:pearl_of_knowledge>, 1, 1, 1, 1);
...
LootUtil.addHardmodeItem(<additions:reward_ticket_common>, 10, 1, 1, 3);
LootUtil.addHardmodeItem(<additions:reward_ticket_rare>, 5, 1, 1, 2);
LootUtil.addHardmodeItem(<additions:reward_ticket_epic>, 2, 1, 1, 1);
LootUtil.addHardmodeItem(<additions:reward_ticket_legendary>, 1, 1, 1, 1);
...
if (CalendarUtil.isChristmas()) {
    LootUtil.addItem(<additions:gift>, 15, 1, 1, 2);
}

if (CalendarUtil.isLunarNewYear()) {
    LootUtil.addItem(<additions:red_packet>, 15, 1, 1, 2);
}
