...
var Tooltipitem as string[IItemStack] = {
    ...
    <contenttweaker:bauble_damage_viewer> : game.localize('content.bauble_damage_viewer_tooltip.name'),
    ...
    <contenttweaker:bauble_living_dew> : game.localize('content.bauble_living_dew_tooltip.name'),
