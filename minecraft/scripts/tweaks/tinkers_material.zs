...
setMaterialArmor(<conmat:redins>, 120.0, 55.5, 6.2, 88.0, 4.0, 52.0);
setMaterialArmor(<conmat:corundum>, 160.0, 58.8, 7.4, 100.0, 3.9, 60.0);
setMaterialArmor(<conmat:pyrophyllite>, 110.0, 54.0, 5.8, 84.0, 4.1, 48.0);
setMaterialArmor(<conmat:lizanite>, 175.0, 62.5, 8.4, 112.0, 3.8, 66.0);
setMaterialArmor(<conmat:spinel>, 105.0, 53.4, 6.0, 82.0, 4.2, 50.0);
setMaterialArmor(<conmat:tourmaline>, 130.0, 57.2, 6.6, 92.0, 4.0, 55.0);
setMaterialArmor(<conmat:prehnite>, 115.0, 52.8, 5.5, 80.0, 4.3, 47.0);
setMaterialArmor(<conmat:cordierite>, 185.0, 63.5, 8.9, 118.0, 3.7, 70.0);
setMaterialArmor(<conmat:opal>, 145.0, 59.4, 7.1, 96.0, 3.95, 58.0);