...
ConversionItem.create(<biomesoplenty:gem:3>).addMatchItem(<tiths:topaz>).register();
ConversionItem.create(<biomesoplenty:gem_block:3>).addMatchItem(<tiths:block_topaz>).register();
ConversionItem.create(<biomesoplenty:gem_ore:3>).addMatchItem(<tiths:ore_topaz>).register();
...
ConversionItem.create(<avaritia:gaia_block>).addMatchItem(<ore:blockGaia>).addMatchItem(<avaritiatweaks:gaia_block>).register();
ConversionItem.create(<avaritia:infinitato>).addMatchItem(<avaritiatweaks:infinitato>).register();
