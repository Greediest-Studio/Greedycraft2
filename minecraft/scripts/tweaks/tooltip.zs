...
val tooltipMap as string[][IIngredient] = {
    ...
    <ore:ingotExtremium> : [hardmode_tinkers],
    <ore:ingotGodlikeum> : [hardmode_tinkers],
    <ore:ingotNonenium> : [hardmode_tinkers],
    ...
    <additions:aeroite_ore> : [game.localize("greedycraft.tooltip.additions.aeroite_ore.1")],
    ...
    <mmce_complement:blockcasing:0> : [game.localize("greedycraft.tooltip.modularmachinery.blockcasing.complement.0"), machinery_upgrade_guide, machinery_upgrade_warning],
    <mmce_complement:blockcasing:1> : [game.localize("greedycraft.tooltip.modularmachinery.blockcasing.complement.1"), machinery_upgrade_guide, machinery_upgrade_warning],
    <mmce_complement:blockcasing:2> : [game.localize("greedycraft.tooltip.modularmachinery.blockcasing.complement.2"), machinery_upgrade_guide, machinery_upgrade_warning],
    <mmce_complement:blockcasing:3> : [game.localize("greedycraft.tooltip.modularmachinery.blockcasing.complement.3"), machinery_upgrade_guide, machinery_upgrade_warning],
    <mmce_complement:blockcasing:4> : [game.localize("greedycraft.tooltip.modularmachinery.blockcasing.complement.4"), machinery_upgrade_guide, machinery_upgrade_warning],
    <mmce_complement:blockcasing:5> : [game.localize("greedycraft.tooltip.modularmachinery.blockcasing.complement.5"), machinery_upgrade_guide, machinery_upgrade_warning],
    ...
    <minecraft:command_block> : [game.localize("greedycraft.tooltip.command_block")],
    ...
    <endexpansion:key> : [game.localize("greedycraft.tooltip.endexpansion.key")],
    <endexpansion:ash_key> : [game.localize("greedycraft.tooltip.endexpansion.key")],
    <contenttweaker:bauble_source_of_swamp> : [game.localize("greedycraft.tooltip.bauble_duplication")],
    <moretcon:ring> : [game.localize("greedycraft.tooltip.bauble_duplication")],
    <gct_mobs:earth_ingot> : [game.localize("greedycraft.tooltip.gct_mobs.earth_ingot")],
    <gct_aby:sanity_altar> : [game.localize("greedycraft.tooltip.gct_aby.sanity_altar.1"), game.localize("greedycraft.tooltip.gct_aby.sanity_altar.2")],
    <gct_aby:ancientmud> : [game.localize("greedycraft.tooltip.gct_aby.sanity_altar.1"), game.localize("greedycraft.tooltip.gct_aby.sanity_altar.2")],
    <ore:dustDiamond> : [game.localize("greedycraft.tooltip.ore.dustDiamond")],
    <thaumcraft:salis_mundus> : [game.localize("greedycraft.tooltip.thaumcraft.salis_mundus")],
    <modularmachinery:blockparallelcontroller> :[game.localize("greedycraft.tooltip.modularmachinery.blockparallelcontroller")],
    <modularmachinery:blockparallelcontroller:1> : [game.localize("greedycraft.tooltip.modularmachinery.blockparallelcontroller")],
    <modularmachinery:blockparallelcontroller:2> : [game.localize("greedycraft.tooltip.modularmachinery.blockparallelcontroller")],
    <modularmachinery:blockparallelcontroller:3> : [game.localize("greedycraft.tooltip.modularmachinery.blockparallelcontroller")],
    <modularmachinery:blockparallelcontroller:4> : [game.localize("greedycraft.tooltip.modularmachinery.blockparallelcontroller")],
    <modularmachinery:blockparallelcontroller:5> : [game.localize("greedycraft.tooltip.modularmachinery.blockparallelcontroller")],
    <modularmachinery:blockparallelcontroller:6> : [game.localize("greedycraft.tooltip.modularmachinery.blockparallelcontroller")],
...
<ore:toolTic>.addAdvancedTooltip(function(item) {
    ...
    //噬魂者
    if (!isNull(item.tag.killcount)) {
        var count as int = item.tag.killcount as int;
        var damage as float = count as float * 0.1f;
        if (str == "") {
            str += "[噬魂者]杀敌数：" + count as string;
            str += "\n[噬魂者]伤害增幅：+" + damage as string;
        } else {
            str += "\n[噬魂者]杀敌数：" + count as string;
            str += "\n[噬魂者]伤害增幅：+" + damage as string;
        }
    }

    //寄生之眼
    if (!isNull(item.tag.parasitism)) {
        var level as int = item.tag.parasitism as int;
        if (str == "") {
            str += "[寄生之眼]等级：" + level as string;
        } else {
            str += "\n[寄生之眼]等级：" + level as string;
        }
    }

    //簇生
    if (!isNull(item.tag.fascicled)) {
        var level as int = item.tag.parasitism as int;
        if (str == "") {
            str += "[簇生]等级：" + level as string;
        } else {
            str += "\n[簇生]等级：" + level as string;
        }
    }
...
<ore:armorTic>.addAdvancedTooltip(function(item) {
    var str as string = "";
    ...
    //厌氧
    if (!isNull(item.tag.oxide)) {
        var level as int = item.tag.oxide as int;
        if (str == "") {
            str += "[厌氧]等级：" + level as string;
        } else {
            str += "\n[厌氧]等级：" + level as string;
        }
    }
