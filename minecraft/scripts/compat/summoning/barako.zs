...
SummoningDirector.addSummonInfo(
    SummoningInfo.create()
        .setCatalyst(<additions:sun_totem>)
        ...
        .addMob(MobInfo.create()
            ...
            .setOffset(0,4,0)
            .setSpread(1,1,1)
            .setData({HandItems: [{id: "additions:solar_seed", Count: 1 as byte, Damage: 0 as short}, {}], HandDropChances: [1.0f, 0.0f], "Health": BARAKO_HP, "Attributes":[{"Name":"generic.maxHealth","Base": BARAKO_HP}]})
        )
        .addMob(MobInfo.create()
