...
val descriptions as string[][IIngredient] = {
    ...
    <additions:experience_ingot> : [game.localize("greedycraft.jei.additions.greedycraft_experience_ingot.desc.0")],
    ...
    <additions:cryonium_ore> : [game.localize("greedycraft.jei.additions.greedycraft_cryonium_ore.desc.0")],
    <additions:infernium_ore> : [game.localize("greedycraft.jei.additions.greedycraft_infernium_ore.desc.0")],
    <additions:cytosinite_ore> : [game.localize("greedycraft.jei.additions.greedycraft_cytosinite_ore.desc.0")],
    <additions:aeroite_ore> : [game.localize("greedycraft.jei.additions.greedycraft_aeroite_ore.desc.0")],
    <additions:asgardium_ore> : [game.localize("greedycraft.jei.additions.greedycraft_asgardium_ore.desc.0")],
    <additions:shadowium_ore> : [game.localize("greedycraft.jei.additions.greedycraft_shadowium_ore.desc.0")],
    <additions:experience_ore> : [game.localize("greedycraft.jei.additions.greedycraft_experience_ore.desc.0")],
    <additions:titanium_ore> : [game.localize("greedycraft.jei.additions.greedycraft_titanium_ore.desc.0")],
    <additions:aqualite_ore> : [game.localize("greedycraft.jei.additions.greedycraft_aqualite_ore.desc.0")],
    <additions:manganese_ore> : [game.localize("greedycraft.jei.additions.greedycraft_manganese_ore.desc.0")],
    <additions:purifying_dust> : [game.localize("greedycraft.jei.additions.greedycraft_purifying_dust.desc.0")],
